...
function Header() {
  ...
  return (
    <header className="bg-transparent flex justify-center items-center py-6 px-11">
      <nav className="border border-slate-800 bg-transparent backdrop-blur-sm rounded-3xl text-gray-800 flex items-center w-3/5">
        <Link
          href={"/"}
          className={`bg-transparent w-1/3 transition-all duration-300 rounded-3xl text-center p-2 ${
            path === "/"
