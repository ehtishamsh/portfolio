...
function AboutMe() {
  return (
    <div className="w-full  mt-20 px-10 py-14  bg-white max-sm:px-4 max-sm:py-8 max-xxxxs:py-3 max-xxxxs:mt-10  relative text-black ">
      ...
      <div className="w-full grid grid-cols-2 max-md:grid-cols-1 gap-24 max-lg:gap-8 mb-28 pb-8 mt-28 max-xxxxs:mt-10 max-xxxxs:mb-10 max-xxxxs:pb-4">
        ...
        <div className=" relative flex justify-center flex-col">
          ...
          <Reveal delayTime={1} width="100%">
            <p className="text-base max-lg:text-sm mb-2 text-justify z-30">
          ...
          <Reveal delayTime={1.2}>
            <p className="text-base max-lg:text-sm text-pretty text-justify z-30">
